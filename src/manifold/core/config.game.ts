/**
 * Default Game Thread Configuration
 *
 * This is the default configuration for the Manifold game thread.
...
import { EditorModule, EditorStateSystem } from "./editor/editor.game";
