...
import { createNodeFromGLTFURI } from "../../core/gltf/gltf.game";
import { createSphereMesh } from "../../core/mesh/mesh.game";
import { defineModule, getModule, Thread } from "../../core/module/module.common";
import { ownedNetworkedQuery } from "../../core/network/network.game";
import { Networked, Owned } from "../../core/network/NetworkComponents";
import { dynamicObjectCollisionGroups } from "../../core/physics/CollisionGroups";
import {
  addPhysicsBody,
  addPhysicsCollider,
...
import { createPrefabEntity, PrefabType, registerPrefab } from "../../core/prefab/prefab.game";
import {
  addObjectToWorld,
  RemoteAudioData,
  RemoteAudioEmitter,
...
import {
  ...
  MaterialType,
  PhysicsBodyType,
} from "../../core/resource/schema";
import { createDisposables } from "../../core/utils/createDisposables";
import randomRange from "../../core/utils/randomRange";
...
import { WorldLoaderModule } from "../world-loader/world-loader.game";
...
export function spawnPrefab(ctx: GameContext, spawnFrom: RemoteNode, prefabId: string, isXR: boolean): boolean {
  const { maxObjectCap } = getModule(ctx, WorldLoaderModule);
