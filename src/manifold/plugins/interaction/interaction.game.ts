...
import { playOneShotAudio } from "../../core/audio/audio.game";
import { unproject } from "../../core/camera/camera.game";
import { OurPlayer, ourPlayerQuery } from "../../core/player/Player";
import { maxEntities, NOOP } from "../../core/config.common";
import { GameContext } from "../../core/GameTypes";
import { enableActionMap } from "../../core/input/ActionMappingSystem";
import { GameInputModule, InputModule } from "../../core/input/input.game";
import { defineModule, getModule, Thread } from "../../core/module/module.common";
import {
  GameNetworkState,
  getPeerIndexFromNetworkId,
  NetworkModule,
  ownedNetworkedQuery,
} from "../../core/network/network.game";
import { Networked, Owned } from "../../core/network/NetworkComponents";
import { takeOwnership } from "../../core/network/ownership.game";
import {
...
} from "../../core/physics/CollisionGroups";
import { PhysicsModule, PhysicsModuleState } from "../../core/physics/physics.game";
import { Prefab } from "../../core/prefab/prefab.game";
import { addResourceRef, getRemoteResource, tryGetRemoteResource } from "../../core/resource/resource.game";
import {
  RemoteAudioData,
  RemoteAudioEmitter,
  RemoteAudioSource,
...
} from "../../core/resource/RemoteResources";
import { AudioEmitterType, InteractableType } from "../../core/resource/schema";
...
import { ActionMap, ActionType, BindingType, ButtonActionState } from "../../core/input/ActionMap";
import { XRAvatarRig } from "../../core/input/WebXRAvatarRigSystem";
import { getRotationNoAlloc } from "../../core/utils/getRotationNoAlloc";
import { PlayerModule } from "../../core/player/Player.game";
import { ZoomComponent, orbitAnchorQuery, OrbitAnchor } from "../../core/player/CameraRig";
import {
  GameRendererModuleState,
  notifyUICanvasFocus,
  notifyUICanvasPressed,
  RendererModule,
} from "../../core/renderer/renderer.game";
import { getCamera } from "../../core/player/getCamera";
import { ThirdRoomMessageType } from "../world-loader/world-loader.common";
import { WorldLoaderModule, WorldLoaderModuleState } from "../world-loader/world-loader.game";
...
export function InteractionSystem(ctx: GameContext) {
  const thirdroom = getModule(ctx, WorldLoaderModule);
...
function updateGrabThrow(
  ...
  input: GameInputModule,
  thirdroom: WorldLoaderModuleState,
  rig: RemoteNode,
